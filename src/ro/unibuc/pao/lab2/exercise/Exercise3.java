package ro.unibuc.pao.lab2.exercise;

import java.util.Scanner;
/**
 * https://github.com/deeas/PAO-2026
 * Cititi de la tastatura n numere. Elementele citite vor fi organizate in doi vectori diferiti,
 * in functie de paritate (de ex: elementele pare in vectorul x, iar cele impare in vectorul y).
 */
