package ro.unibuc.pao.lab9.data_streams;
...
public class Main {
    ...
    public  static void readUsingDataInputStream() {
        try (DataInputStream dataInputStream = new DataInputStream(new FileInputStream("lab9.txt"))) {
    ...
    public static void writeUsingDataOutputStream(String text) {
        try(DataOutputStream dataOutputStream = new DataOutputStream( new FileOutputStream("lab9.txt"))) {
